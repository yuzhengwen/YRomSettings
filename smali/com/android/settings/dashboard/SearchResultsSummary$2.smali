...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-static {v1}, Lcom/android/settings/dashboard/SearchResultsSummary;->access$600(Lcom/android/settings/dashboard/SearchResultsSummary;)Lcom/android/settings/dashboard/SearchResultsSummary$SuggestionsAdapter;

    move-result-object v1

    # getter for: Lcom/android/settings/dashboard/SearchResultsSummary$SuggestionsAdapter;->mCursor:Landroid/database/Cursor;
    invoke-static {v1}, Lcom/android/settings/dashboard/SearchResultsSummary$SuggestionsAdapter;->access$700(Lcom/android/settings/dashboard/SearchResultsSummary$SuggestionsAdapter;)Landroid/database/Cursor;
    ...
    invoke-static {v1, v2}, Lcom/android/settings/dashboard/SearchResultsSummary;->access$802(Lcom/android/settings/dashboard/SearchResultsSummary;Z)Z
    ...
    invoke-static {v1, v2}, Lcom/android/settings/dashboard/SearchResultsSummary;->access$902(Lcom/android/settings/dashboard/SearchResultsSummary;Ljava/lang/String;)Ljava/lang/String;

    iget-object v1, p0, Lcom/android/settings/dashboard/SearchResultsSummary$2;->this$0:Lcom/android/settings/dashboard/SearchResultsSummary;

    # getter for: Lcom/android/settings/dashboard/SearchResultsSummary;->mSearchView:Landroid/widget/SearchView;
    invoke-static {v1}, Lcom/android/settings/dashboard/SearchResultsSummary;->access$1000(Lcom/android/settings/dashboard/SearchResultsSummary;)Landroid/widget/SearchView;
    ...
    invoke-static {v2}, Lcom/android/settings/dashboard/SearchResultsSummary;->access$900(Lcom/android/settings/dashboard/SearchResultsSummary;)Ljava/lang/String;
