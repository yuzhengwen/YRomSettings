...
.field protected mSearchMenuItemExpanded:Z
...
.method static constructor <clinit>()V
    ...
    const-class v2, Lcom/sonymobile/settings/nfc/HceSettings;
    ...
    const-class v2, Lcom/sonymobile/settings/stamina/appusage/AppUsageOverview;
    ...
    const-class v2, Lcom/sonymobile/settings/stamina/xssm/XssmSettings;
...
.method private shallShowDashboard()Z
    .locals 3
...
.method private updateTilesList(Ljava/util/List;)V
    ...
    invoke-virtual {v4, v0}, Landroid/app/admin/DevicePolicyManager;->isSettingsDisabled(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {v3, v10}, Lcom/android/settings/dashboard/DashboardCategory;->getTile(I)Lcom/android/settings/dashboard/DashboardTile;
    ...
    const v17, 0x7f0f0293

    move/from16 v0, v17

    if-eq v8, v0, :cond_0

    const v17, 0x7f0f029e
    ...
    invoke-virtual {v3, v10}, Lcom/android/settings/dashboard/DashboardCategory;->removeTile(I)V
    ...
    const-string v18, "android.hardware.wifi"
    ...
    const-string v18, "android.hardware.bluetooth"
    ...
    :try_start_0
    invoke-interface {v11}, Landroid/os/INetworkManagementService;->isBandwidthControlEnabled()Z
    :try_end_0
    ...
    const-string v18, "android.hardware.nfc"
    ...
    const-string v18, "android.hardware.nfc.hce"
    ...
    const-string v18, "android.software.print"
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    :cond_9
    invoke-direct/range {p0 .. p0}, Lcom/android/settings/SettingsActivity;->shallShowDashboard()Z
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {v3, v6}, Lcom/android/settings/dashboard/SearchResultsSummary;->setSearchView(Landroid/widget/SearchView;)V
    ...
    invoke-virtual {v3, v2, v5}, Landroid/widget/SearchView;->setQuery(Ljava/lang/CharSequence;Z)V
...
.method public onResume()V
    ...
    invoke-direct {p0}, Lcom/android/settings/SettingsActivity;->shallShowDashboard()Z
