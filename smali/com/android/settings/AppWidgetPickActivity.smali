...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/android/settings/AppWidgetPickActivity$1;

    invoke-direct {v0, p0}, Lcom/android/settings/AppWidgetPickActivity$1;-><init>(Lcom/android/settings/AppWidgetPickActivity;)V

    iput-object v0, p0, Lcom/android/settings/AppWidgetPickActivity;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Lcom/android/settings/AppWidgetPickActivity;->mPackageManager:Landroid/content/pm/PackageManager;

    invoke-static {p0}, Landroid/appwidget/AppWidgetManager;->getInstance(Landroid/content/Context;)Landroid/appwidget/AppWidgetManager;

    move-result-object v2

    iput-object v2, p0, Lcom/android/settings/AppWidgetPickActivity;->mAppWidgetManager:Landroid/appwidget/AppWidgetManager;

    new-instance v2, Lcom/android/settings/AppWidgetLoader;

    iget-object v3, p0, Lcom/android/settings/AppWidgetPickActivity;->mAppWidgetManager:Landroid/appwidget/AppWidgetManager;

    invoke-direct {v2, p0, v3, p0}, Lcom/android/settings/AppWidgetLoader;-><init>(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;Lcom/android/settings/AppWidgetLoader$ItemConstructor;)V

    iput-object v2, p0, Lcom/android/settings/AppWidgetPickActivity;->mAppWidgetLoader:Lcom/android/settings/AppWidgetLoader;
    ...
    iput v2, p0, Lcom/android/settings/AppWidgetPickActivity;->mAppWidgetId:I
    ...
    iget-object v2, p0, Lcom/android/settings/AppWidgetPickActivity;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0, v2, v0}, Lcom/android/settings/AppWidgetPickActivity;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method public onDestroy()V
    ...
    invoke-super {p0}, Lcom/android/settings/ActivityPicker;->onDestroy()V

    iget-object v0, p0, Lcom/android/settings/AppWidgetPickActivity;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0, v0}, Lcom/android/settings/AppWidgetPickActivity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
